...
`d577ebc3b469ecb3b3eaa36c35a3461814d3d1ba` completed compatibility,
recoverable failure behavior, exact-path and symlink safety, and executable and
debug-file identity/metadata preservation. Current `git blame` also names historical
